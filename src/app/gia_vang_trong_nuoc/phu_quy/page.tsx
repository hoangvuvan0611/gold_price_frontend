...
import {pqApi} from "@/services/pqApi";
...
export default function PQPage() {
  ...
  useEffect(() => {
    pqApi.getCommonData().then((response: ApiResponseData<GoldCommonPrice>) => {
      debugger
      if (response.success) {
  ...
  return (
    <div className="min-h-screen mt-16">
      ...
      <div className={'mt-36'}>
        <GoldRegionPriceTable titleTable={'PHÚ QUÝ'} goldRegionPrice={regionPrice} timeUpdateStr={timeUpdateStr}/>
      </div>
