...
import {ntApi} from "@/services/ntApi";
...
export default function NTPage() {
  ...
  useEffect(() => {
    ntApi.getCommonData().then((response: ApiResponseData<GoldCommonPrice>) => {
      debugger
      if (response.success) {
  ...
  return (
    <div className="min-h-screen mt-16">
      ...
      <div className={'mt-12 sm:mt-16 lg:mt-36'}>
        <GoldRegionPriceTable titleTable={'NGỌC THẨM'} goldRegionPrice={regionPrice} timeUpdateStr={timeUpdateStr}/>
      </div>
