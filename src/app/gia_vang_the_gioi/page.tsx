...
export default function GoldWorld() {
  ...
  return (
    <div className="min-h-screen mt-16 px-4 max-w-6xl mx-auto">
      {/* Header Section */}
      <div className="mb-8 text-center">
        <h1 className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-amber-500 to-amber-600 bg-clip-text text-transparent">
          Giá Vàng Thế Giới
        </h1>
        <p className="text-gray-500 mt-2">{priceCommonInfo.lastUpdate}</p>
      </div>
      ...
      {!isLoading && (
        <>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-1 bg-white rounded-2xl shadow-lg p-6 border border-gray-100">
              <div className="text-center mb-6">
                <div className="flex justify-center items-baseline">
                  <span className="text-4xl font-bold text-gray-800">{priceCommonInfo.currentPrice}</span>
                  <span className="text-lg text-gray-500 ml-2">{priceCommonInfo.unit}</span>
                </div>

                <div className={`inline-flex items-center mt-3 px-4 py-2 rounded-full ${isPositive ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}`}>
              ...
              <div className="space-y-4">
                <div className="justify-between items-center p-4 bg-blue-50 rounded-xl">
                  <div className="text-gray-700 font-medium">1 Ounce</div>
                  <div className="text-base font-semibold text-blue-700">{formatVND(priceCommonInfo.priceInVND)}</div>
                </div>

                <div className="flex justify-between items-center p-4 bg-amber-50 rounded-xl">
                  <div className="text-gray-700 font-medium">1 Lượng</div>
                  <div className="text-base font-semibold text-amber-700">{formatVND(priceCommonInfo.pricePerTael)}</div>
                </div>
              </div>
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-100">
                <h2 className="text-xl font-bold mb-4 text-gray-800">Biểu đồ xu hướng giá vàng thế giới</h2>
                <TradingViewAdvanceWidget/>
              </div>

              {/* Forex Chart */}
              <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-100">
                <h2 className="text-xl font-bold mb-4 text-gray-800">Biểu đồ FOREX xu hướng tỷ giá VNĐ/USD</h2>
          ...
          <div className="mt-8 bg-white rounded-2xl shadow-lg p-6 border border-gray-100">
            <h2 className="text-xl font-bold mb-4 text-gray-800">Thông tin bổ sung</h2>
